...
async def mistral(query: str, context: str = "", history: str = "", input_type: Literal['voice', 'csv', 'text'] = 'text'):
    ...
    prompt = (
        ...
        "6. Используй HTML теги где нужно что то выделить. Делай текст хорошо структурированным и понятным. НЕ ИСПОЛЬЗУЙ MARKDOWN. Только эти теги HTML (<b>, <i>, <a>, <code>, <pre>) НЕЛЬЗЯ ИСПОЛЬЗОВАТЬ <ul>!"
